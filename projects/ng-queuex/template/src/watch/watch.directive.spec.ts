...
import { Priority, PriorityLevel, PriorityName, completeIntegrationForTest, provideNgQueuexIntegration, whenIdle } from "@ng-queuex/core";
...
describe('QueuexWatch directive', () => {
  ...
  //   it('Should update embedded view locally if consumed signal will change.', () => {
  //     const template =
